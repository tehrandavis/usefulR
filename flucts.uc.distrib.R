...
#library(wmtsa)
#library(multicore)
#save("flucts.uc.distrib" ,file="/Users/jdixon_old/Documents/R_Stuff/flucts.uc.distrib.RData")
...
flucts.uc.distrib<-function (x, detrend = "poly1", sum.order = 0, overlap = 0, scale.max = trunc(length(x)/2), 
...
lapply(frame.start.list,frame.process,framesize,totrow,x)->fr.out
